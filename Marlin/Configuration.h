...
#define STRING_CONFIG_H_AUTHOR "(Randy, Ender-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-5 4.2.7-bltouch"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp   19.1
    #define DEFAULT_Ki   1.34
    #define DEFAULT_Kd   68.1
  #endif
#endif // PIDTEMP
